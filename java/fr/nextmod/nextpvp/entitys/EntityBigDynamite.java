...
public class EntityBigDynamite extends EntityThrowable implements IEntityAdditionalSpawnData {
    private int fuseTime = 30;

    public EntityBigDynamite(World world) {
        super(world);
    }

    public EntityBigDynamite(World world, EntityLivingBase thrower) {
        super(world, thrower);
    }
